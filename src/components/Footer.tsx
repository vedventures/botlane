  ...
  return (
    <footer className="bg-gradient-to-b from-[#f9fafb] to-[#f5f3ff] pt-16 sm:pt-20 pb-8 sm:pb-10 border-t border-purple-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-8 md:px-14 lg:px-24 relative z-10">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="col-span-2 sm:col-span-2 mb-2 sm:mb-0">
            ...
            <p className="text-[#4b5563] mb-6 max-w-md text-sm sm:text-base leading-relaxed">
              Empowering businesses through innovative digital solutions. We specialize in web development, digital marketing, and AI integration to elevate your brand&apos;s digital presence.
            </p>
            <div className="flex space-x-5">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" 
                className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-[#64748b] hover:text-white hover:bg-[#7c3aed] transition-all duration-300 group">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1 mt-2 sm:mt-4 lg:mt-0">
            ...
            <ul className="space-y-4 sm:space-y-5 text-xs sm:text-sm">
              <li className="flex items-start group">
                ...
                <div>
                  <span className="text-[#4b5563] text-xs sm:text-sm font-medium block mb-0.5">Visit Us</span>
        ...
        {/* Bottom Section */}
        <div className="relative mt-12 sm:mt-16 pt-8 sm:pt-10 flex flex-col md:flex-row justify-between items-center">
          {/* Decorative divider */}
